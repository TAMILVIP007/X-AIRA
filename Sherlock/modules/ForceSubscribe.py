            ...
            try:
                ...
                try:
                    sent_message = message.reply_text(
                        "Hey  {} 🙏 \n \n **pls join @{} Channel Join ** 😭 \n and press**UNMUTE ME** Button  touch කරන්න. \n \n **[👉 OUR CHANNEL 👈](https://t.me/{})**".format(
...
✪ Force subscribing modules.
✪ Froce subscribering module make admin in group and chanell and type commands senn below.
